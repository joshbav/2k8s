#!/bin/bash
# downloaded from https://raw.githubusercontent.com/mesosphere/dcos-kubernetes-cluster/master/kubernetes-cluster/tools/setup_security_kubernetes-cluster.sh 
# on 11-15-18

# commented out by josh set -ex
